...
_$DeviceCardWidgetConfigImpl _$$DeviceCardWidgetConfigImplFromJson(
    ...
    _$DeviceCardWidgetConfigImpl(
      ...
      parameterLabelFont: json['parameterLabelFont'] as Map<String, dynamic>? ??
          const {
            'fontFamily': 'Open Sans',
            'fontSize': 15,
            'fontColor': 0xFF000000,
...
Map<String, dynamic> _$$DeviceCardWidgetConfigImplToJson(
        _$DeviceCardWidgetConfigImpl instance) =>
    <String, dynamic>{
