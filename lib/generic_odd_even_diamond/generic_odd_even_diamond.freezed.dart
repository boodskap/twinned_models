...
GenericOddEvenDiamondWidgetConfig _$GenericOddEvenDiamondWidgetConfigFromJson(
    Map<String, dynamic> json) {
  return _GenericOddEvenDiamondWidgetConfig.fromJson(json);
}

/// @nodoc
mixin _$GenericOddEvenDiamondWidgetConfig {
  ...
  set evenDiamondBGColor(int value) => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $GenericOddEvenDiamondWidgetConfigCopyWith<$Res> {
  factory $GenericOddEvenDiamondWidgetConfigCopyWith(
          GenericOddEvenDiamondWidgetConfig value,
          $Res Function(GenericOddEvenDiamondWidgetConfig) then) =
      _$GenericOddEvenDiamondWidgetConfigCopyWithImpl<$Res,
          GenericOddEvenDiamondWidgetConfig>;
  @useResult
  $Res call(
      {String title,
...
/// @nodoc
class _$GenericOddEvenDiamondWidgetConfigCopyWithImpl<$Res,
        $Val extends GenericOddEvenDiamondWidgetConfig>
    implements $GenericOddEvenDiamondWidgetConfigCopyWith<$Res> {
  _$GenericOddEvenDiamondWidgetConfigCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      oddDiamondBGColor: null == oddDiamondBGColor
          ...
          : oddDiamondBGColor // ignore: cast_nullable_to_non_nullable
              as int,
      evenDiamondBGColor: null == evenDiamondBGColor
          ? _value.evenDiamondBGColor
          : evenDiamondBGColor // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
abstract class _$$GenericOddEvenDiamondWidgetConfigImplCopyWith<$Res>
    implements $GenericOddEvenDiamondWidgetConfigCopyWith<$Res> {
  factory _$$GenericOddEvenDiamondWidgetConfigImplCopyWith(
          _$GenericOddEvenDiamondWidgetConfigImpl value,
          $Res Function(_$GenericOddEvenDiamondWidgetConfigImpl) then) =
      __$$GenericOddEvenDiamondWidgetConfigImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String title,
...
/// @nodoc
class __$$GenericOddEvenDiamondWidgetConfigImplCopyWithImpl<$Res>
    extends _$GenericOddEvenDiamondWidgetConfigCopyWithImpl<$Res,
        _$GenericOddEvenDiamondWidgetConfigImpl>
    implements _$$GenericOddEvenDiamondWidgetConfigImplCopyWith<$Res> {
  __$$GenericOddEvenDiamondWidgetConfigImplCopyWithImpl(
      _$GenericOddEvenDiamondWidgetConfigImpl _value,
  ...
  $Res call({
    ...
    return _then(_$GenericOddEvenDiamondWidgetConfigImpl(
      title: null == title
          ? _value.title
          : title // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericOddEvenDiamondWidgetConfigImpl
    extends _GenericOddEvenDiamondWidgetConfig {
  _$GenericOddEvenDiamondWidgetConfigImpl(
      {this.title = 'Generic Odd Even Diamond',
  ...
  factory _$GenericOddEvenDiamondWidgetConfigImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GenericOddEvenDiamondWidgetConfigImplFromJson(json);
  ...
  _$$GenericOddEvenDiamondWidgetConfigImplCopyWith<
          _$GenericOddEvenDiamondWidgetConfigImpl>
      get copyWith => __$$GenericOddEvenDiamondWidgetConfigImplCopyWithImpl<
          _$GenericOddEvenDiamondWidgetConfigImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericOddEvenDiamondWidgetConfigImplToJson(
      this,
    );
  }
}

abstract class _GenericOddEvenDiamondWidgetConfig
    extends GenericOddEvenDiamondWidgetConfig {
  factory _GenericOddEvenDiamondWidgetConfig(
      {String title,
      Map<String, dynamic> titleFont,
      String subTitle,
      Map<String, dynamic> subTitleFont,
      ...
      int evenDiamondBGColor,
      double horizontalSpacing,
      double imageSize}) = _$GenericOddEvenDiamondWidgetConfigImpl;
  _GenericOddEvenDiamondWidgetConfig._() : super._();

  factory _GenericOddEvenDiamondWidgetConfig.fromJson(
          Map<String, dynamic> json) =
      _$GenericOddEvenDiamondWidgetConfigImpl.fromJson;
  ...
  @override
  int get evenDiamondBGColor;
  set evenDiamondBGColor(int value);
  @override
