...
_$GenericMultiShapeWidgetImpl _$$GenericMultiShapeWidgetImplFromJson(
...
Map<String, dynamic> _$$GenericMultiShapeWidgetImplToJson(
        _$GenericMultiShapeWidgetImpl instance) =>
    <String, dynamic>{
